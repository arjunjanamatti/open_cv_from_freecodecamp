    ...
    def main(self):
        try:
            with open('data.pickle') as file:
                words_corpus, labels_list, features_nested, labels_empty_nested = pickle.load(file)

        except:
            self.data = self.json_to_dict()
            words_corpus = []
            sentence_list = []
            labels_list = []
        ...
        return words_corpus, labels_list, features_nested, labels_empty_nested


filename = 'intents.json'
check_1 = bag_of_words(filename)
words_corpus, labels_list, features_nested, labels_empty_nested = check_1.main()
